...
public class ExportNoInitCli {
    public static void main(String[] args) {
        // Tidak memanggil initDatabase agar seed yang sudah ada tidak hilang
        ...
        File out = new File(outDir, "riwayat_test_bulanan_noinit.csv");
